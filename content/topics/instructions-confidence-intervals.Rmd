...
* [What is a confidence interval?](/lessons/what_is_a_confidence_interval/)
* [Sampling bias and confidence intervals](/lessons/sampling-bias/)
* [Comparing two groups](/lessons/comparing-two0groups)
...
#. Interpret a lack of overlap as an indication that the two estimation processes did not each sample at random from the same population.
#. Recognize and appropriately make use of the confidence interval as an presentation of uncertainty due to sampling.
...
- [Word version of this document](`r paste0("/word-versions/",tools::file_path_sans_ext(knitr::current_input()), ".docx")`)
...
Many students (and professionals) will acquire a completely incorrect interpretation of confidence intervals and treat them as if they were summary intervals. For instance, consider an estimate of mean commute time and it's confidence interval. Many people will mistakenly think that "most" commute times fall within the confidence interval. In reality the fraction that do can be vanishingly small for large n.
