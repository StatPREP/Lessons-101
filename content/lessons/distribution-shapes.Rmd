...
2. Pick one of the three rules of thumb to estimate the mean and standard deviation. 
    ...
    `r question_blank("*Write down your estimates of the mean and the standard deviation.*")`

3. Check the "Std. deviation" box to turn on a ruler calibrated in units of the standard deviation. 

    `r question_blank("*How close were your estimates in (2)  to the actual values displayed by the ruler?*")`
...
5. As you work through different variables, note which ones have a violin corresponding to the bell-shaped normal curve. The rules of thumb work best for variables that have a normal-like distribution.
    ...
    `r question_blank("*Write down two variables with a bell-shaped distribution.*", breaks = 2)`


    `r question_blank("*Write down at least one variable that **does not have** a bell-shaped distribution.*", breaks = 2)`
