...
In (2), it still the case that thermostat causes condensation. But I know something about condensation and I want to figure out about the thermostat.  So condensation should be the explanatory variable and thermostat the response.
