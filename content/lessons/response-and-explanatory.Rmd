...
-------------|--------------|-------------------------|-------------
Quantitative | Quantitative |  linear regression      | [linear regression](`r LR$url`)^[<`r LR$url`>].
Quantitative | Categorical  |  group-wise means       | [t-test](`r TT$url`)^[<`r TT$url`>].
Categorical  | Quantitative |  proportion regression  | [proportions](`r PR$url`)^[<`r PR$url`>].
Categorical  | Categorical  |  group-wise proportions | [proportions](`r PR$url`)^[<`r PR$url`>].
...
Version 0.3, `r Sys.Date()`, Danny Kaplan, 